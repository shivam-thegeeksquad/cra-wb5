...
//     port: 3002,
//   }, 
// //   ---manually updated the port at 8002 in the start script.
   
//   output: {
//     publicPath: 'auto', 
// 	// ---set to auto in the path last line
//   },
//   module: {
//     rules: [
//       {
...
// Addijg some more plugin required for MFE

// const HtmlWebpackPlugin = require('html-webpack-plugin');
// const path = require('path');

// the above plugin is commneted because already added in the file
const { ModuleFederationPlugin } = require('webpack').container;
